import rlbase
from rlbase.user_config import DEFAULT_BACKEND
from rlbase.utils.run_utils import ExperimentGrid
...
MPI_COMPATIBLE_ALGOS = ['vpg', 'ppo']

# Algo names (used in a few places)
BASE_ALGO_NAMES = ['vpg', 'ppo', 'ddpg', 'td3', 'sac']
...
if __name__ == '__main__':
    ...
    if cmd in valid_help:
        ...
        special_info = dedent("""
            ...
            \tpython -m rlbase.run ppo --env HalfCheetah-v2 --clip_ratio 0.1

            If you need a quick refresher on valid kwargs, get the docstring
            with

            \tpython -m rlbase.run [algo] --help
